...
function onWindowLoaded() {
    tryToListenByJQuery('#js_serials_button', 'click', showMore);
    tryToListenByJQuery('#link_popup', 'click', openForm);
    tryToListenByJQuery('#serial_add_button', 'click', openSerialAddForm);
...
function showMore(event) {
    var serialsButton = tryToGet('#js_serials_button');
    var blockToShow = tryToGet('#js_serials_content');
    event.preventDefault();
    serialsButton.fadeOut(500);
    blockToShow.fadeIn(500);
}

function openForm() {
    var body = $('body');
    var container = tryToGet('#js_container_form');
...
function openSerialAddForm() {
    var body = $('body');
    var container = tryToGet('#form_container_serial');
    var formSelector = '#serial_form';
    event.preventDefault();
...
function filmCardsAdapt(indicatorClass) {
    var toRevealSelector = '.serial .container_serial_info_block p.description';
    var adaptiveClassToDelete = 'revealator_height';
